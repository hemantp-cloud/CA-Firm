...
export default function SuperAdminServiceRequestsPage() {
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                    Review and approve service requests from all clients
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <Card
                    className={`border-0 shadow-sm cursor-pointer transition-all ${filter === 'all' ? 'ring-2 ring-blue-500' : ''}`}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex-1">
                                                ...
                                                <div className="flex flex-wrap items-center gap-2 mt-2">
                                                    <Badge variant="outline">{SERVICE_TYPE_LABELS[request.serviceType]}</Badge>
                                        ...
                                        <div className="flex flex-wrap gap-4 text-sm text-gray-500 mb-3">
                                            ...
                                            {request.financialYear && <span>FY: {request.financialYear}</span>}
                                        </div>
                                        ...
                                        {isPending && (
                                            <div className="flex gap-2 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                                ...
                                                <Button variant="destructive" onClick={() => handleRejectClick(request)}>
            ...
            <Dialog open={approveDialogOpen} onOpenChange={setApproveDialogOpen}>
                <DialogContent className="max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>Approve to create a new service</DialogDescription>
                    </DialogHeader>
                    {selectedRequest && (
