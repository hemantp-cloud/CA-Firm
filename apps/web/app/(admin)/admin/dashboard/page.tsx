...
import { Users, UserCircle, Briefcase, Clock, CreditCard, AlertCircle, Plus, FileText, Receipt, FolderOpen, Folder } from "lucide-react"
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button asChild variant="outline" size="sm">
              <Link href="/admin/client-documents">
