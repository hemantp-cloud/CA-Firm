...
import { Users, UserCircle, Briefcase, Clock, AlertCircle, Receipt } from "lucide-react"
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KPI Cards Grid - Ordered by Hierarchy */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-600 dark:text-gray-400">Project Managers</span>
            </div>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-white">
              {isLoading ? "..." : dashboardData?.projectManagerCount || 0}
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Active managers</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900 dark:text-white">
              {isLoading ? "..." : dashboardData?.teamMemberCount || 0}
            </div>
