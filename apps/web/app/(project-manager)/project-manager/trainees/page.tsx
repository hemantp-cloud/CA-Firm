...
import { Plus, Search, Eye, Trash2, MoreVertical, Users } from "lucide-react"
...
export default function CATeamMembersPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <Button asChild>
                    <Link href="/project-manager/trainees/new">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/project-manager/trainees/${member.id}`} className="cursor-pointer">
                                                            <Eye className="h-4 w-4 mr-2" />
                                                            View Details
                                                        </Link>
                                                    </DropdownMenuItem>
                                                    <DropdownMenuItem asChild>
                                                        <Link href={`/project-manager/trainees/${member.id}/assign-clients`} className="cursor-pointer">
