 ...
 */
export async function getUserDashboard(userId: string, firmId: string) {
 ...
 */
export async function getUserServices(userId: string, firmId: string) {
 ...
 */
export async function getUserServiceById(serviceId: string, userId: string, firmId: string) {
 ...
 */
export async function getUserDocuments(userId: string, firmId: string, filters: any = {}) {
  const where: any = {
    userId,
    firmId,
  };
 ...
 */
export async function getUserInvoices(userId: string, firmId: string) {
 ...
 */
export async function getUserInvoiceById(invoiceId: string, userId: string, firmId: string) {
 ...
 * Get USER profile
 */
export async function getUserProfile(userId: string, firmId: string) {
 ...
 * Update USER profile
 */
export async function updateUserProfile(userId: string, firmId: string, userData: any) {
  const user = await prisma.user.findFirst({
    where: {
      id: userId,
      firmId,
